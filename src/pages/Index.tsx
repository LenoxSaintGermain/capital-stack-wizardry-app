...
const Index = () => {
  ...
  const sections = [
    { id: 'deal-selector', title: 'Deal Selection', icon: Building, iconColor: 'text-blue-500' },
    { id: 'agent-control', title: 'AI Agent Control', icon: Target, iconColor: 'text-purple-500' },
        ...
        <main className="flex-1 p-6 lg:p-10 overflow-y-auto">
          ...
          {selectedDeal ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-gray-600 mb-2">No Deal Selected</h3>
